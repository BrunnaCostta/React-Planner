      ...
      <section className="px-3 py-4">
        {!tasks.length && (
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-300 mt-2">Nenhuma tarefa para esta data.</p>
          </div>
        )}
        <div className="flex flex-col items-center w-full">
          {tasks.map((item, index) => (
            <label
              key={index}
              className="flex items-center border my-2 border-gray-300 px-3 py-2 w-full rounded text-white"
            >
              <input
                type="checkbox"
